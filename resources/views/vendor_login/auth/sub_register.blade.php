...
<div class="row top">
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-success">
                ...
                <h4 class="text-center"> Register Sub-Vendor </h4> 
                    <form class="form-horizontal top" role="form" method="POST" action="{{ url('sub_vendor_login_register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="name" type="text" class="form-control" placeholder="@ vendor name" name="name" value="{{ old('name') }}" required autofocus>
                       ...
                       <div class="row">
                            ...
                            <div class="col-md-8">
                                <input id="password" type="password" placeholder="@type in your pwd" class="form-control" name="password" required>
                            ...
                            <div class="col-md-8">
                                <input id="password-confirm" type="password" placeholder="@confirm your pwd" class="form-control" name="password_confirmation" required>
                            </div>
                        </div>
                            </div>
                   ...
                   <h5 class="text-center top"> <em>Belongs too : </em> </h5>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                                <div class="form-group">
                            <label for="name" class="col-md-4 control-label">sub vendor id</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                            <div class="form-group">
                            <label for="name" class="col-md-4 control-label">vendor_address</label>

                            <div class="col-md-8">

                                <select name="sub_vendor_address_id" class="form-control form-control-lg" id="lgFormGroupInput" >
                            ...
                            <div class="col-md-8">
                                 ...
                                 <select name="sub_vendor_venue_id" class="form-control form-control-lg" id="lgFormGroupInput" >
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8">
                                 ...
                                 <select name="sub_vendor_court_id" class="form-control form-control-lg" id="lgFormGroupInput" >
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8">
                                 ...
                                 <select name="sub_vendor_stall_id" class="form-control form-control-lg" id="lgFormGroupInput" >
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="hidden" name="is_ven_or_sub" value="1">
                            </div>
                        </div>
