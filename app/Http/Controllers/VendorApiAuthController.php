...
class VendorApiAuthController extends Controller
{
    ...
    public function authenticate()
    {
    	...
    	try
    	{
    		Config::set('auth.providers.users.model', \App\models\VendorLogin::class);
    ...
    public function returnstall($stall)
    {
    	...
    	$stall_id = VendorLogin::select('vendor_stall_id')->where('email', $stall_email)->first();
        $stall_id_main = $stall_id['vendor_stall_id'];
